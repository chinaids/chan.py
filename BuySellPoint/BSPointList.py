...
from .BuySellPoint import CBuySellPoint
...
class CBSPointList(Generic[LINE_TYPE, LINE_LIST_TYPE]):
    def __init__(self, bs_point_config: CBSPointConfig):
        self.lst: List[CBuySellPoint[LINE_TYPE]] = []
        self.bsp1_lst: List[CBuySellPoint[LINE_TYPE]] = []
    ...
    @overload
    def __getitem__(self, index: int) -> CBuySellPoint: ...

    @overload
    def __getitem__(self, index: slice) -> List[CBuySellPoint]: ...

    def __getitem__(self, index: Union[slice, int]) -> Union[List[CBuySellPoint], CBuySellPoint]:
    ...
    def add_bs(
        ...
        bi: LINE_TYPE,
        relate_bsp1: Optional[CBuySellPoint],
    ...
    def treat_bsp2s(
        ...
        bsp2_bi: LINE_TYPE,
        break_bi: LINE_TYPE,
        real_bsp1: Optional[CBuySellPoint],
    ...
    def getLastestBspList(self) -> List[CBuySellPoint[LINE_TYPE]]:
        if len(self.lst) == 0:
            return []
